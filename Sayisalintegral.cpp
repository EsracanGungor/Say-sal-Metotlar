...
int main() {
	...
	double h;
	double  x0 = 0, x1 = 4;
	double y0 = exp(0), y1 = exp(4);// f(x) degerleri
	...
	double xsimp0 = 0, xsimp1 = 2, xsimp2 = 4;//simpsonun x degerleri
	double ysimp0 = exp(0), ysimp1 = exp(2), ysimp2 = exp(4);//y degerleri
	...
	double xs0 = 0, xs1 = 1.3333, xs2 = 2.6666,xs3=4;//simpsonun 3/8 x degerleri
	double ys0 = exp(0), ys1 = exp(1.3333), ys2 = exp(2.6666), ys3 = exp(4);//xlerin artıs degeri h ile belirleniyor
	h = (xs3 - xs0) / 3;//n=3 
	double ssonuc;
	...
	double xb0 = 0, xb1 = 1, xb2 = 2, xb3 = 3,xb4=4;//simpsonun 3/8 x degerleri
	double yb0 = exp(0), yb1 = exp(1), yb2 = exp(2), yb3 = exp(3),yb4=exp(4);//xlerin artıs degeri h ile belirleniyor
	h = (xb4 - xb0) /4;//n=4
	double sbonuc;
